...
[lpm: this could be a place to include a reference to the science communication courses at NAU]

## Curriculum Vitae

Keep your CV up to date. We share our CVs within the group in [NPM: we need this] [this Google Drive folder](https://drive.google.com/drive/folders/1_VDBjhUkH4Tx4IeUTPKsmQueFKEhQi4f), both to give each other ideas about what to include, but also having these in one place makes it easier for Gavin and others to reference information from them when needed.  
...
We often get the opportunity to share our science with local media, or give our take on the climate science topic du jour. Nick and Darrell often get more requests than others, but we also both prefer for more junior members of the group, including students, to get the opportunity to work with the media. If this is something you're really excited about, let us know! If this is something you don't want to do, that's also ok, let us know and we won't pass anything your way. If you do get the opportunity to work with a reporter, either directly or via your advisor, you are never obligated to do so. 
